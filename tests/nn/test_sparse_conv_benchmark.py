...
def test_sparse_conv_explicit_benchmark(setup_voxels, benchmark):
    ...
    benchmark.pedantic(
        ...
        kwargs={
            ...
            "dgrad_algo": SPARSE_CONV_AB_ALGO_MODE.EXPLICIT_GEMM,
            "wgrad_algo": SPARSE_CONV_ATB_ALGO_MODE.EXPLICIT_GEMM,
        },
        rounds=5,
        iterations=1,
    )
...
def test_sparse_conv_auto_benchmark_and_correctness(setup_voxels, benchmark):
    ...
    out_auto_result = benchmark.pedantic(
        ...
        kwargs={
            ...
            "dgrad_algo": SPARSE_CONV_AB_ALGO_MODE.AUTO,
            "wgrad_algo": SPARSE_CONV_ATB_ALGO_MODE.AUTO,
        },
        rounds=5,
        iterations=1,
    )
