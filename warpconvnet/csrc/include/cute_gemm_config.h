...
// during wcn build (dev-log PR #2 surfacing, 2026-05-07). Guarded
...
// gemm_mma_tiles.h decl). dev-log Option 1 cleanup.
...
// 8-warp Layout<_4,_2,_1> variant — dev-log axis A2.
template <>
...
// 8-warp BF16 variant — dev-log axis A2.
template <>
...
// 8-warp F16Acc variant — dev-log axis A2.
template <>
