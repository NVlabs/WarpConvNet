...
// -----------------------------------------------------------------------------
// Tile selector enum classes — dev-log Option 1 SoT.
//
...
enum class DgradTile : int {
  // Dgrad tile selectors. Members marked '_wt' are dgrad-via-fwd aliases (dev-log T4).
  _64x64x32_2s = 0,
  _64x128x32_2s = 1,
  _128x64x32_3s = 2,
  _64x128x32_3s = 3,
