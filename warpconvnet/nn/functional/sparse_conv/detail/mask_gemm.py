...
#      and {903} dgrad-wt.
#
# AUTHORIZATION vs AVAILABILITY (dev-log) — the guard is an AVAILABILITY fact:
...
# per-shape; dev-log). The warpgemm sweep validated all three at MW2/4, so the
...
def _select_dgrad_tile(
    ...
    if not cin_aligned or not cout_aligned:
        ...
        # Native dgrad pcoff (dev-log): autotune-driven tile_id 64-69 wins for
